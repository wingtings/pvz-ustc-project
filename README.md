...
| 发布与协作 | 构建脚本、清单和测试记录已入库；新增 Windows/Ubuntu 公开 CI 配置 | CI 结果见 [Actions](https://github.com/wingtings/pvz-ustc-project/actions/workflows/checks.yml)；尚无 Release，玩家用安装与回滚流程待完成 |
