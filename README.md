...
文案由[同步工具](tools/README.md)从设计文档生成，测试范围记录在 [v0.2 文案冒烟测试](tests/checklists/v0.2-text-smoke.md)。首批美术对象和概念稿见[资源清单](docs/art-resource-inventory.md)。下一步不是直接做 GPA 钩子，而是先补齐文案回归，再建立可重放、可回滚的常量补丁框架。完整安排见[开发路线图](docs/roadmap.md)。
