...
| 原创贴图与 reanim 动画 | P01、P02、P04 已完成首轮白天观察；Z03 图鉴、泳池行走与啃食、三档损伤和脱落也已实机通过；眨眼、跨场景和 Z01 候选仍待补齐 |
...
文案由[同步工具](tools/README.md)从设计文档生成，测试范围记录在 [v0.2 文案冒烟测试](tests/checklists/v0.2-text-smoke.md)。首批美术对象和概念稿见[资源清单](docs/art-resource-inventory.md)。P01 的圆框眼镜与《电磁学千题解》、P02 的学习头带与便签花瓣、P04 的三档校园墙体，以及 Z03 逐步破损的蓝色习题册书套，都由差分脚本从本地合法原件生成；Git 不保存混有原版像素的合成 PNG。

构建细节见[原创素材 PAK 构建](docs/asset-build-pipeline.md)。静态与实机证据分别记录在 [P01 白天垂直切片](tests/checklists/v0.5-p01-ingame.md)、[P02/P04 累计包观察](tests/checklists/v0.5-p02-p04-ingame.md)、[P04 4200 组合验证](tests/checklists/v0.5-p04-4200-combo.md)、[Z03 静态验收](tests/checklists/v0.5-z03-static.md)和 [Z03 实机观察](tests/checklists/v0.5-z03-ingame.md)。当前累计开发包替换 11 项资源。接下来补 P01/P02 的眨眼帧和跨场景抽查，再制作 Z01 共享躯干候选。v0.3 的[常量补丁框架](docs/v0.3-patching.md)已经能生成和逐字节回滚开发副本。完整安排见[开发路线图](docs/roadmap.md)。
