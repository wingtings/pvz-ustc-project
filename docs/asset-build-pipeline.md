...
确定性差分脚本已经能从哈希匹配的原版 PAK 生成首轮候选：

```powershell
python tools/build_z01_sprites.py --build --preview --check
```

| 部件 | 画布 | 候选 SHA-256 | 改动 / 新增 / 删除 | 旧纸 / 铅笔 / 批改红 |
| --- | ---: | --- | ---: | ---: |
| `Zombie_body.png` | 53×63 | `DA899F703AA5322A9042281A2DE78522556D737F7D4FD456500EEA85917D3A63` | 1134 / 0 / 0 | 932 / 157 / 43 |
...
加入 Z01 旧卷面共享躯干后的当前累计清单为 `patches/manifests/v0.5-p01-p02-p04-z01-z03-ingame.json`，共替换十二项：
